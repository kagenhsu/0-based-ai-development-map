...
6.語言需求：正式、專業、落地，符合國內(台灣)互聯網團隊開發交付標準，無需沉餘廢話，可直接用於評審、開發、測試`,
  ...
  prototypeGuide: {
    title: "第四步：原型設計（頁面交互）",
    lead: "PRD 是文字，原型則是可以直接點擊、操作與驗收的網頁。",
    intro: [
      "原型雖然還沒有連接真實資料，但可以先完整走過頁面、導覽、彈窗與表單流程。",
      "在撰寫正式程式碼前先確認操作方式，可以更早看見想法與實際使用之間的偏差，降低後續開發返工。"
    ],
    journey: [
      { number: "01", title: "閱讀 PRD", description: "確認頁面、功能與業務規則" },
      { number: "02", title: "產生可點擊原型", description: "建立頁面、彈窗、表單與導覽" },
      { number: "03", title: "實際操作驗收", description: "逐步點擊並截圖回報問題" }
    ],
    prompt: `你是產品原型專家，嚴格依據PRD輸出高保真產品原型設計
輸出要求：
梳理全部頁面、彈窗、抽屜、浮層；每個頁面寫清楚佈局結構
每一個組件說明清楚：位置、文字、按鈕文案、組件類型、默認狀態
交互動實現寫清楚：點擊哪個按鈕→發生甚麼，跳轉去哪里，彈窗展示甚麼，表單題驗題示文案、彈窗、全局組件(導覽列、底部tab、側邊選單)
不做UI視覺美化描述，只講原型結構，方便直接照著拖曳組件畫圖
PRD資訊不足時標記【需產品確認】，不腦補需求`,
    acceptance: [
      "點擊導覽列，確認能切換不同功能。",
      "點擊「新增運動記錄」，確認表單會出現並能填寫、儲存。",
      "回到清單頁，確認新增的記錄已經出現。",
      "發現不正確的地方時截圖並標示位置，再告訴 AI 如何調整。"
    ],
    changeExample: [
      "添加飲食記錄時，需要增加卡路里攝取量。",
      "設定頁不需要使用幫助和隱私說明。",
      "首頁增加卡路里模組，包含基礎消耗、運動消耗與攝取量。",
      "計算今日卡路里缺口：攝取量－基礎消耗－運動消耗。"
    ],
    demoPrompt: "給這份原型，_______________，讓我可以直接原型查看",
    impact: [
      "原型調整可能同時改變產品功能、分析建議、趨勢內容，以及底層資料保存與計算邏輯。",
      "修改完成後，不只要更新畫面，也要系統性同步功能清單、PRD 與原型，避免文件版本互相矛盾。"
    ],
    syncPrompt: "根據當前調整，依次系統性的更新功能清單、產品需求文檔PRD、原型到最新版本",
    closing: "持續操作、截圖與修正，直到原型流程符合需求；文件同步更新後，再進入 UI 視覺設計。"
  },
  uiGuide: {
    title: "第五步：UI 設計（好看）",
    lead: "原型確認後，再替產品建立一致、清楚且可實作的視覺介面。",
    intro: [
      "可以直接描述想要的設計風格，也可以提供參考截圖，請 AI 依照畫面層級、留白、卡片、字體與配色方向設計。",
      "只有風格關鍵字時，設計結果可能仍較普通；搭配參考圖與 UI 設計 Skill，通常能更明確地提升視覺完成度。"
    ],
    formula: [
      { number: "01", title: "好關鍵字", description: "說清楚風格、產品氣質與使用情境" },
      { number: "02", title: "好參考圖", description: "提供喜歡的版面、配色與元件截圖" },
      { number: "03", title: "好 Skill", description: "使用 /ui-ux-pro-max 強化層級與細節" }
    ],
    prompt: `/ui-ux-pro-max

你是資深前端UI工程師，專業UI設計師的AI團隊主管
基於產品需求與原型，輸出完整UI設計
頁面需求請嚴格遵守產品需求，頁面佈局與互動都要遵守先前的產品需求和原型
主題風格：是簡約科技風格，參考蘋果網站或行動裝置ios的設計風格
配色：根據設計風格，選擇合適的主色、輔助色、中性色`,
referenceTips: [
      "提供 2～4 張最接近目標風格的畫面，並指出要參考的是版面、配色、元件或留白。",
      "不要只說『照著做』，要標明哪些元素需要保留、哪些只作為風格參考。",
      "介面完成後逐頁操作，檢查導覽、按鈕、表單、彈窗與不同螢幕尺寸。"
    ],
    progress: [
      "第一層：只提供風格關鍵字，先建立基本視覺方向。",
      "第二層：加入 iOS 或其他產品截圖，校準卡片、留白與元件細節。",
      "第三層：使用 /ui-ux-pro-max 重新檢查資訊層級、可讀性、響應式與操作體驗。"
    ],
    syncPrompt: "請依據剛才的調整，幫我全面系同更新整理：功能清單、產品需求文件PRD、產品原型、UI設計",
    closing: "UI 驗收與文件同步完成後，功能、需求、原型與視覺設計即可一起定稿，交給後續技術文件與開發階段。"
  },
  sections: [
